...
def index(request):
    ...
    view_vars = {
        ...
        'actions': [{ 'name': "New Deployment Program", 'url': "/Aurora/manager/deployment_programs/new/" }]
    }
    c = Context({
...
def detail(request, deployment_program_id):
    view_vars = {
        ...
        'actions': [
            { 'name': "Back to List", 'url': "/Aurora/manager/deployment_programs/" },
        ]
    }
    try:
...
class DeploymentProgramForm(forms.Form):
    action = "/Aurora/manager/deployment_programs/new/"
...
def new(request):
    if request.method == 'POST': # If the form has been submitted...
        ...
        if form.is_valid(): # All validation rules pass
            ...
            return redirect('manager-deployment-programs-index') # Redirect after POST
    else:
...
def delete(request, deployment_program_id):
    ...
    return redirect('manager-deployment-programs-index')
