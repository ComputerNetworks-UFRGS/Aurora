...
urlpatterns = patterns('cloud.views',
    ...
    url(r'^virtual_machines/$', 'virtual_machines.index',
        name='cloud-virtual-machines-index'),
    ...
    #Hosts
    url(r'^hosts/$', 'hosts.index', name='cloud-hosts-index'),
    ...
    url(r'^virtual_links/$', 'virtual_links.index',
        name='cloud-virtual-links-index'),
    ...
    url(r'^virtual_routers/$', 'virtual_routers.index',
        name='cloud-virtual-routers-index'),
    ...
    url(r'^virtual_routers/(?P<virtual_router_id>\d+)/delete_remote_controller/(?P<remote_controller_id>\d+)/$',
        'virtual_routers.delete_remote_controller'),
    url(r'^virtual_routers/(?P<virtual_router_id>\d+)/delete_virtual_interface/(?P<virtual_interface_id>\d+)/$',
        'virtual_routers.delete_virtual_interface'),
    url(r'^virtual_routers/(?P<virtual_router_id>\d+)/' +
    ...
    #Slices
    url(r'^slices/$', 'slices.index', name='cloud-slices-index'),
    ...
    url(r'^deployment_programs/$', 'deployment_programs.index',
        name='cloud-deployment-programs-index'),
    ...
    url(r'^optimization_programs/$', 'optimization_programs.index',
        name='cloud-optimization-programs-index'),
    ...
    url(r'^metrics/$', 'metrics.index', name='cloud-metrics-index'),
    ...
    url(r'^events/$', 'events.index', name='cloud-events-index'),
    ...
    url(r'^monitoring/settings/$', 'monitoring.settings',
        name='cloud-monitoring-settings'),
